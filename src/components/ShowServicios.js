...
//                             </MDBTableHead>
//                             <MDBTableBody>
//                                 {adquisicionesList.map((adquisicion,i)=>(
...
//                             <Link to={"/index"} className="col-md-4 offset-md-0 btn btn-dark">
...
//                         <td></td>
//                         <td> 
//                             <button onClick={()=> openModal(1)} className='col-md-12 offset-md-0 btn btn-success' data-bs-toggle='modal' data-bs-target={`#modalProducts-${selectedOption}`}>
